...
export default function Error({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#0A0A0A] text-[#F5F0E8] p-4 text-center">
      <h2 className="text-2xl font-serif mb-4 text-[#D4AF37]">Ana Sayfa Yüklenirken Bir Hata Oluştu!</h2>
      <p className="text-[#C8C8C8] mb-6">Lütfen sayfayı yenilemeyi deneyin.</p>
      <button
        onClick={() => reset()}
